...
*/
$config['composer_autoload'] = BASEPATH.'../vendor/autoload.php';
...
// if (isset($_SERVER["REQUEST_URI"]) && stripos($_SERVER["REQUEST_URI"], '/user/') ) {
...
|--------------------------------------------------------------------------
*/
$config['file_manager_key'] = '686d68b1b20d600fcdd0581eafbf81b0';
$config['file_manager_url'] = 'filemanager';
