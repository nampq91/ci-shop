...
if( !function_exists('dd') ) {
     ...
     * @return void
     */
    function dd($data = NULL, $die = true, $add_var_dump = false, $add_last_query = true) {
        $CI = &get_instance();
        ...
        $output .= '</div><p class="debugfooter">Debug from cCMS © 2015. Code by Pham Dinh Cuong</p></div></div>';
        $output .= '<div style="clear:both;"></div>';
...
/* End of file cdebug_helper.php */
/* Location: ./application/helpers/cdebug_helper.php */