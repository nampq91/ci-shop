...
$config = array(
	...
	*/
	...
	'base_url' => str_replace('/filemanager/','',(isset($_SERVER['HTTPS']) && strtolower($_SERVER['HTTPS']) !== 'off' ? 'https://' : 'http://'). $_SERVER['HTTP_HOST'] . str_replace(basename($_SERVER['SCRIPT_NAME']), '', $_SERVER['SCRIPT_NAME'])) ,
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => '../uploads/thumb/',
